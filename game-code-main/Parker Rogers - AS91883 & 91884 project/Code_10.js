...
num = 10//amount of obsticles i want to generate
...
function renderObsticales(){//render obsticales
	...
	for(let i = 0; i < obsticales.length; i ++){
		console.log(i+","+obsticales.length)
		ctx.fillRect(obsticales[i].x, obsticales[i].y, obsticales[i].width, obsticales[i].height, obsticales[i].colour)
	}
}
