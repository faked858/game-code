...
function renderObsticales(){//render obsticales
	...
	ctx.fillRect(obsticales[2].x, obsticales[2].y, obsticales[2].width, obsticales[2].height, obsticales[2].colour)//obsticale 3
	ctx.fillRect(obsticales[3].x, obsticales[3].y, obsticales[3].width, obsticales[3].height, obsticales[3].colour)//obsticale 4
	ctx.fillRect(obsticales[4].x, obsticales[4].y, obsticales[4].width, obsticales[4].height, obsticales[4].colour)//obsticale 5
	ctx.fillRect(obsticales[5].x, obsticales[5].y, obsticales[5].width, obsticales[5].height, obsticales[5].colour)//obsticale 6
	ctx.fillRect(obsticales[6].x, obsticales[6].y, obsticales[6].width, obsticales[6].height, obsticales[6].colour)//obsticale 7
	ctx.fillRect(obsticales[7].x, obsticales[7].y, obsticales[7].width, obsticales[7].height, obsticales[7].colour)//obsticale 8
	ctx.fillRect(obsticales[8].x, obsticales[8].y, obsticales[8].width, obsticales[8].height, obsticales[8].colour)//obsticale 9
...
function startCanvas(){
	...
	generateObstacles(10)//number in constructor is one more than number of obsticles i want to make
